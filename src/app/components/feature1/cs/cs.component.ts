...
export class CSComponent implements OnInit {
  ...
  table5 = [
    {id: 70501,page:'Continuous Security', stageDef: 'Staging', practiceStage: 'Basic', description: 'No tools or technologies available to monitor the security in Production.', score: 1, value: 1, tooltip: '1', name: 'val4' },
    {id: 70501, stageDef: 'Staging', practiceStage: 'Initial', description: 'Some basic tools are available for monitoring the security in production, but, they are not integrated across.', score: 3, value: 3, tooltip: '3', name: 'val4' },
    {id: 70501, stageDef: 'Staging', practiceStage: 'Developed', description: 'Tools are available like OpenVas that checks visible ports, services and it has been integarted. Notifications are received from tools detecting the threats/vulnerabilities.', score: 5, value: 5, tooltip: '5', name: 'val4' },
    ...
    {id: 70501, stageDef: 'Staging', practiceStage: 'Optmized', description: 'All Tools are available. We have customized notifications, cutsomized policies, Custom isolation policies and we have Hackerone-PT to receive, manage and track the incoming vulnerability disclores with the industrys most trusted and reputable ethical hackers.', score: 10, value: 10, tooltip: '10', name: 'val4' },
  ];
 table6 = [
  {id: 70601,page:'Continuous Security', stageDef: 'Production', practiceStage: 'Basic', description: 'No tools or technologies available to monitor the security in Production.', score: 1, value: 1, tooltip: '1', name: 'val4' },
  {id: 70601, stageDef: 'Production', practiceStage: 'Initial', description: 'Some basic tools are available for monitoring the security in production, but, they are not integrated across.', score: 3, value: 3, tooltip: '3', name: 'val4' },
  {id: 70601, stageDef: 'Production', practiceStage: 'Developed', description: 'Tools are available like OpenVas that checks visible ports, services and it has been integarted. Notifications are received from tools detecting the threats/vulnerabilities.', score: 5, value: 5, tooltip: '5', name: 'val4' },
